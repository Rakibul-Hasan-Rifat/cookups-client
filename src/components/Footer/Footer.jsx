...
const Footer = () => {
    const footerStyles = { color: '#FFF', backgroundColor: 'rgb(79, 182, 92)', padding: '50px 80px' }
    return (
    	...
    	c0.11,0.2,0.15,0.42,0.14,0.64l0,0c-1.03-0.49-1.92-1.24-2.57-2.17C42.23,42.47,41.6,39.82,42.12,37.27z">
                    ...
                    <div style={{ display: 'flex', gap: '15px' }}>
                        <Link to='https://play.google.com/store/apps' target="_blank">
                            <div style={{ display: 'flex', gap: '6px', alignItems: 'center', backgroundColor: '#FFF', color: 'rgb(79, 182, 92)', borderRadius: '8px', padding: '6px 12px', fontWeight: '600' }}>
                        ...
                        <Link to='https://www.apple.com/app-store/' target="_blank">
                            <div style={{ display: 'flex', gap: '6px', alignItems: 'center', backgroundColor: '#FFF', color: 'rgb(79, 182, 92)', borderRadius: '8px', padding: '6px 12px', fontWeight: '600' }}>
                                ...
                                <span style={{ fontSize: '20px' }}>Apple Store</span>
                            </div>
                        </Link>
                    </div>
                </div>
            ...
            <div style={{textAlign: 'center', marginTop: '50px'}}>
                <p>&copy;Cookups Technologies Limited</p>
            </div>
        </footer>
    );
};
